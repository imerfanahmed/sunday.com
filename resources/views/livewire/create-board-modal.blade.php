        ...
        <div x-show="show" x-transition:enter="ease-out duration-300"
            ...
            <form wire:submit="save">
                ...
                <div class="px-6 py-4 border-b">
                    <h2 class="text-xl font-semibold text-gray-900">Create New Board</h2>
                </div>

                <!-- Body -->
                <div class="px-6 py-6 space-y-6">
                    <flux:input wire:model="name" label="Board Name" placeholder="e.g., Marketing Campaign 2026"
                        required />

                    <flux:textarea wire:model="description" label="Description" placeholder="What is this board for?"
                        rows="3" />
                ...
                <div class="px-6 py-4 border-t flex justify-end gap-3">
                    ...
                    <flux:button type="submit" variant="primary">Create Board</flux:button>
                </div>
            </form>
        </div>
    </div>
