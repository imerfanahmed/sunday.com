            ...
            @if($board)
                <form wire:submit="save">
                    ...
                    <div class="px-6 py-4 border-b">
                        <h2 class="text-xl font-semibold text-gray-900">Add Column to {{ $board->name }}</h2>
                    </div>

                    <!-- Body -->
                    <div class="px-6 py-6 space-y-6">
                        <flux:input wire:model="name" label="Column Name" placeholder="e.g., To Do, In Progress, Done"
                            required />

                        <div>
                            <flux:label>Column Color</flux:label>
                    ...
                    <div class="px-6 py-4 border-t flex justify-end gap-3">
                        ...
                        <flux:button type="submit" variant="primary">Add Column</flux:button>
                    </div>
                </form>
            @endif
        </div>
